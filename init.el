...
;; Increase GC threshold during startup to 100 MB (default is 800 KB)
...
;; Set the title
(setq dashboard-banner-logo-title "Welcome to the Thunder Dome!!!")
;; Set the banner
(setq dashboard-startup-banner "~/.emacs.d/dash/tiger.jpg")
;; Size the image
(setq dashboard-banner-scale-factor 0.25)
...
;; Inserted at the end so that there are no conflicts with other packages and this overwrites everything else.
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dashboard which-key forge magit counsel-projectile projectile hydra evil-collection evil general helpful counsel ivy-rich ivy command-log-mode rainbow-delimiters all-the-icons doom-themes doom-modeline)))
(custom-set-faces
